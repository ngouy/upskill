...
Check in order. Stop at the first "no" — that's the current stage:
...
| 4 | `git remote get-url origin` points to GitHub? | github-hosted |
...
Ask visibility (public / private / org). Confirm before acting. Run `gh repo create <name> --[public|private] --source=. --push`.
